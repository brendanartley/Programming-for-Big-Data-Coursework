...
public class WordCountImproved extends Configured implements Tool {
	...
	extends Mapper<LongWritable, Text, Text, LongWritable>{
		...
		public void map(LongWritable key, Text value, Context context
			...
			// used replaceAll inplace of regex pattern matcher
			line = line.replaceAll("&.*?\\w+;", " ").replaceAll("[^a-zA-Z0-9 ]", " ").replaceAll("\\s+", " "); 
			//only execute if line isnt empty or just spaces  
